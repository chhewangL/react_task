      ...
      <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96" onSubmit={formik.handleSubmit}>
        <div className="mb-4 flex flex-col gap-4">
          <div>
            ...
            <Input size="lg" label="Name" name="username" onChange={formik.handleChange} value={formik.values.username} />
          ...
          <Input size="lg" label="Email" name='email' onChange={formik.handleChange} value={formik.values.email} />
          ...
          <div>
            ...
            <div className="w-72">
              <Select label="Select Country" name='country' onChange={(e) => formik.setFieldValue('country', e)} value={formik.values.country} >
                {country.map((cont) => {
          ...
          <div>
            ...
            <div className="flex gap-10">
              {gender.map((gen, i) => {
                return <Radio name="gender" onChange={formik.handleChange} label={gen.label} color={gen.color} value={gen.value} key={i} checked={gen.value === formik.values.gender ? true : false} />
          ...
          <div>
            ...
            <div>
              {hobies.map((hobie, i) => {
                return <Checkbox onChange={formik.handleChange} label={hobie.label} value={hobie.value} name="hobies" color={hobie.color} checked={formik.values.hobies.includes(hobie.value) ? true : false} />;
              })}
          ...
          <div>
            ...
            <div className="w-96">
              <Textarea label="Message" name="msg" onChange={formik.handleChange} value={formik.values.msg} />
            </div>
